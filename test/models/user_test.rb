...
class UserTest < ActiveSupport::TestCase
  ...
  test "Creates user and profile if it doesn't exist" do
    stub_get_user_info User.new(uid: "new_user_uid", first_name: "Pepe", last_name: "Viyuela", email: "pepe@gmail.com", access_token: "new_user_token", expires_at: "new_user_expiration")
